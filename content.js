window.addEventListener('load', () => {
  ...
  // Load existing user preferences from chrome.storage.sync
  ...
  async function generateContent(text) {
    ...
    // check if user preferences is not empty string
    if (userPreferences) {
      text = text + '. Provide advice on whether the user perferences are matched. USER PREFERENCES:' + userPreferences;
    }
    const data = { text };
                ...
                <div class="card-content" style="display: flex; align-items: center;">
                    ...
                    <div style="flex-grow: 1; text-align: center;">
                        ...
                        <div style="margin-top: 5px; font-size: 10px; color: #666;">
                            <p><b>Note:</b> Summary generated by AI. Check for mistakes. You can set your property preferences in the extension popup for personalized results and reload the page.</p>
                        </div>
                    </div>
                </div>
                `;
